...
@section('title', 'Restricted Page')
@section('footer-class', 'blurred-footer')

@section('content')
<!-- Blurred Hero Section -->
<section class="hero-section d-flex justify-content-center align-items-center blurred-background">
    <div class="section-overlay"></div>

    <!-- Background SVG -->
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#777D94" fill-opacity="1" d="M0,224L34.3,192C68.6,160,137,96,206,90.7C274.3,85,343,139,411,144C480,149,549,107,617,122.7C685.7,139,754,213,823,240C891.4,267,960,245,1029,224C1097.1,203,1166,181,1234,160C1302.9,139,1371,117,1406,106.7L1440,96L1440,0L1405.7,0C1371.4,0,1303,0,1234,0C1165.7,0,1097,0,1029,0C960,0,891,0,823,0C754.3,0,686,0,617,0C548.6,0,480,0,411,0C342.9,0,274,0,206,0C137.1,0,69,0,34,0L0,0Z"></path>
    </svg>
        ...
        <div class="row">
            <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                ...
                <div class="custom-btn-group">
                    <a href="{{ url('/about') }}" class="btn custom-btn smoothscroll me-3">My Story</a>
...
<section class="events-section section-padding blurred">
...
<section class="events-section section-bg section-padding blurred">
    <div class="container">
        <div class="row">
...
<div class="modal fade" id="professorModal" tabindex="-1" aria-labelledby="professorModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h5 class="modal-title text-center" id="professorModalLabel" style="flex: 1; text-align: center;">Access Restricted</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Only professors are allowed to view this page.
            </div>
        </div>
    </div>
</div>
...
<!-- Page-specific style and script -->
<style>
    .modal {
        display: none;
        position: fixed;
...
.blurred-background {
  position: relative;
  overflow: hidden;
  z-index: 1; /* Ensure it is beneath the navigation */
}
...
.section-overlay {
  ...
  z-index: 1; /* Overlay stays behind content */
}
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var professorModal = new bootstrap.Modal(document.getElementById('professorModal'));
        professorModal.show();
    });
</script>
